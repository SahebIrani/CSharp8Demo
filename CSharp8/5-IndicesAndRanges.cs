...
namespace CSharp8
{
    public static class IndicesAndRangesDemo
    {
        public static void Demo()
        {
            ...
            string[] places = new string[] { "first", "second", "third", "fourth", "fifth" };
